        ...
        <div className="agb">
          ...
          <div className="tags">
            ...
            {/* Отметка СЛОВАМИ и на экране, а не в `title`: подсказка при
                ...
                Пилюля НЕЙТРАЛЬНАЯ, хотя речь про ограничение: `.pill.warn` и
                `.pill.bad` в этом файле — один и тот же `--hot`, то есть
                оранжевая отметка сказала бы «сломано» про сознательно
                выставленную настройку. Потолок системы — не авария, а
                решение владельца; смысл несут слова. */}
            {потолок !== null && (
              <span className="pill">
