 ...
 */
const STATE_LED: Record<AgentState, string> = {
  working: "led working",
  blocked: "led blocked",
  // Пауза и молчание — базовая лампа (`--tx-2`): состояние известно, поэтому
  // квадрат залит, но «нормой» оно не является. Пауза дополнительно гаснет
  // плиткой (`.agtile[data-state="paused"]`) — она не проснётся сама.
  paused: "led",
  idle: "led",
};
