...
describe("Стиль ребра", () => {
  ...
  it("упоминания рисуются ВИДИМЫМ токеном, а не разделителем", () => {
    // `--line` — токен внутренних разделителей (#2c3324 на тёмном холсте):
    // на нём 478 рёбер из 522 просто пропадали, и граф выглядел горстью
