...
--            осознанно: в attachment на проде сегодня десятки строк полевого
--            контура, и лишний индекс — плата за КАЖДУЮ запись без выигрыша
--            на чтении. Когда витрина наберёт объём — отдельная миграция.
--
